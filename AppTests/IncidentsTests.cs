...
namespace AppTests
{
    public class IncidentsTests
    {
        ...
        //Test 4b - PutIncident ID mismatch
        [Fact]
        ...
        //Test 5a - DeleteIncident existant
        [Fact]
        ...
        // Test 5b - DeleteIncident non trouvé
        [Fact]
        ...
        // Test C1 - titre manquant
        [Fact]
        public async Task PostIncident_MissingTitle_ReturnsBadRequest()
        {
            var context = GetDbContext();
            var controller = new IncidentsDbController(context);
            var incident = new Incident { Status = "OPEN", Severity = "HIGH" };
        ...
        public async Task PostIncident_ValidSeverity_ReturnsCreated(string severity)
        {
            var context = GetDbContext();
            var controller = new IncidentsDbController(context);
            var incident = new Incident { Title = "Test", Status = "OPEN", Severity = severity };
